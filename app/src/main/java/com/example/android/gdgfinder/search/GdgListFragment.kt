...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        /**
         * (04) Create an observer on viewModel.regionList. Override the required
         * onChanged() method to include the following changes.
         */
        viewModel.regionList.observe(viewLifecycleOwner, object: Observer<List<String>> { // Идея говорит заменить object на лямбду
            override fun onChanged(data: List<String>?) {
                data ?: return

                /**
                 * (05) Create a new layoutInflater from the ChipGroup.
                 * */
                val chipGroup = binding.regionList
                val inflater = LayoutInflater.from(chipGroup.context)

                /**
                 * (06) Use the map() function to create a Chip for each item in regionList and
                ...
                /**
                 * (07) Call chipGroup.removeAllViews() to remove any views already in chipGroup.
                 * */
                chipGroup.removeAllViews()

                /**
                 * (08)  Iterate through the list of children and add each chip to chipGroup.
                 * */
